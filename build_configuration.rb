configuration do |c|
	...
	# default value: "quizzer"
	#
	c.project_name = "quizzer"
	...
	# default value: []
	#
	c.files_to_copy = [#'lib/quizzer/images/systray.gif',
                           'lib/quizzer.ico']
	...
	# default value: {}
	#
	c.extra_user_jars[:extra] = { :directory => 'lib/quizzer/images',
	                             :location_in_jar => 'lib/quizzer/images',
                                   }
	#                             :exclude => /*.bak$/ }
	...
	# default value: nil
	#
	c.windows_icon_path = "lib/quizzer.ico"
